...
def generate_adj_pems08():
    distance_df_filename, num_of_vertices = "data/PEMS08/PEMS08.csv", 170
    #distance_df_filename, num_of_vertices = "data/PEMS08/edges_data_09.csv", 67
    ...
    with open("data/PEMS08/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("data/PEMS08/adj_PEMS08_distance.pkl", "wb") as f:
